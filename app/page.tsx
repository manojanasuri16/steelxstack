...
import { creator, apps, products } from "@/data/storefrontData";
import SectionWrapper from "@/components/SectionWrapper";
import AppCard from "@/components/AppCard";
import ProductCard from "@/components/ProductCard";

const categories = ["All", "Shoes", "Gym Wear", "Accessories", "Watches", "Essentials"] as const;
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center px-4 overflow-hidden">
        ...
        >
          ...
          <div className="mx-auto mb-6 w-28 h-28 rounded-full bg-dark-700 border-2 border-neon/50 flex items-center justify-center neon-glow">
            <span className="text-4xl font-bold text-neon">SX</span>
          </div>
